...
namespace Ywl.Data.Entity.Models
{
    ...
    public class User : Ywl.Data.Entity.Models.BaseUser
    {
        ...
        /// 微信公众号OpenId
        /// </summary>
        [Display(Name = "微信公众号OpenId", Description = "微信公众号OpenId")]
        [MaxLength(50)]
        ...
        public User(User source) { this.CopyFrom(source); }
    ...
    public class UserOracleMap : EntityTypeConfiguration<User>
    {
        public UserOracleMap(string schemaName)
        {
            ...
            this.Property(e => e.OrganizationId).HasColumnName("OrgId".ToUpper());
            this.Property(e => e.OrganizationPath).HasColumnName("OrgPath".ToUpper());
            ...
            this.Property(e => e.WxOpenId).HasColumnName("WxOpenId".ToUpper());
        }
    }
    public class UserMSSqlMap : EntityTypeConfiguration<User>
    {
        public UserMSSqlMap(string schemaName)
        {
            ...
            this.Property(e => e.WxOpenId).HasColumnName("WxOpenId");
        }
    }
}
...

{
    ...
    "entityName":"User",
    "inheritedFrom":"Ywl.Data.Entity.Models.BaseUser",
    "entityTitle":"用户",
    "entityDesc":"系统登录用户",
